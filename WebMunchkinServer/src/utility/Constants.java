...
/**
 * 
 * Konstantenklasse. Sollte nicht initialisiert werden!
 * 
...
public final class Constants
{
	...
	public static String certificate_path = "certificates" + File.separator
			+ "mySrvKeystore";
	...
	public static String jar_sql_database_driver = jar_path + File.separator
