...
/**
 * WebMunchkin Login Client. Baut eine SSL (Secure Sockets Layer) gesicherte
 * Verbindung zum WebMunchkinServer auf und startet den Programmablauf.
 * 
...
public class Client
{
	...
	private static void serverConnection()
	{
		...
		try
		{
			// Setze SystemProperties für das Laden und öffnen der
			// Zertifikatdatei
